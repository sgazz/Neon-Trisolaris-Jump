export class AudioManager {
    ...
    playJump() {
        ...
        try {
            const { oscillator, gainNode, context } = this.sounds.jump;
    ...
    playPlatformHit() {
        ...
        try {
            const { oscillator, gainNode, context } = this.sounds.platformHit;
    ...
    playGameOver() {
        ...
        try {
            const { oscillator, gainNode, context } = this.sounds.gameOver;
    ...
    playPowerUp() {
        ...
        try {
            const { oscillator, gainNode, context } = this.sounds.powerUp;
